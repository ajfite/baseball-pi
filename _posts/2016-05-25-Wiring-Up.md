...
For my main scoreboard display I used an [HD44780]({{ site.url }}baseball-pi/assets/HD44780.pdf) based 4x20 character display.  The screen is in
4-bit mode and uses 6 GPIO pins to operate.  This makes my wiring relatively simple:

![Wiring Diagram]({{ site.url }}baseball-pi/images/2016-05-25-wiring.svg)
